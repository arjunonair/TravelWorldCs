...
const TourDetails = () => {
  ...
  const {photo, title, desc, price, address, reviews, city, distance, maxGroupSize} = tour //destructuring of objects
                          ...
                          <div className='w-100'>
                            <div className='d-flex align-items-center justify-content-between'>
                              <div>
                                ...
                                <p>
                                  {
                                    new Date('05-12-2023').toLocaleDateString('en-IN', options)
                                  }
                                </p>
                              </div>
