...
declare const _default: {
    name: string;
    buildAuthenticatedRouter: (admin: import("adminjs/types/src/adminjs").default, auth: import("./types").AuthenticationOptions, predefinedRouter?: import("express").Router | null | undefined, sessionOptions?: import("express-session").SessionOptions | undefined, formidableOptions?: import("./types").FormidableOptions | undefined) => import("express").Router;
    buildRouter: (admin: import("adminjs/types/src/adminjs").default, predefinedRouter?: import("express").Router | null | undefined, formidableOptions?: import("./types").FormidableOptions | undefined) => import("express").Router;
};
